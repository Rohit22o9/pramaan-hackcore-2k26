...
class _EvidenceReportScreenState extends State<EvidenceReportScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadReportData() async {
    ...
    final voiceTranscript = args?['voice_transcript'] ?? "Sprayed 400ml Bio-Neem in 200L water for whitefly protection.";
    ...
    final disease = args?['disease_detected'] ?? "Foliar Pest Pressure / Mild Chlorosis";
    ...
    try {
      final res = await _api.generateAuditReport(
        ...
        weatherTemp: farmProv.weatherAdvisory?.currentWeather.temperatureC ?? 28.5,
        weatherHumidity: farmProv.weatherAdvisory?.currentWeather.humidityPercent ?? 68.0,
        weatherWind: farmProv.weatherAdvisory?.currentWeather.windSpeedKmh ?? 5.4,
      ...
      if (mounted) {
        setState(() {
          ...
          _anchorHash = res['blockchain_hash_anchor'] ?? 'a98f73b610c492e8810237dfb4a92c301e76bba920194857bca1029384756bc0';
          _complianceScore = (res['compliance_score_percent'] as num?)?.toDouble() ?? 98.6;
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text("Cryptographic SHA-256 Proof Copied to Clipboard!")),
              );
            },
          ),
        ],
          ...
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text("JSON Proof Manifest Exported with Full Multi-Agent Chain!")),
                  );
                },
  ...
  Widget _buildLanguageReportView(String langKey) {
    ...
    final certTitle = langData['cert_title'] ??
        (isHi
    ...
    final subtitle = langData['subtitle'] ??
        (isHi
    ...
    final pageTag = isHi ? "पृष्ठ २ / ३ (हिंदी)" : (isMr ? "पृष्ठ ३ / ३ (मराठी)" : "Page 1 of 3 (English)");
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: AppColors.primaryDark.withOpacity(0.2), blurRadius: 12, offset: const Offset(0, 4)),
              ],
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
          ...
          _buildCardContainer(
            title: isHi ? "किसान एवं प्रक्षेत्र विवरण (Farm Profile)" : (isMr ? "शेतकरी व शेताचा तपशील (Farm Profile)" : "FARM & GROWER PROFILE"),
            icon: Icons.person_pin_rounded,
            color: AppColors.primary,
            children: [
              _buildDataRow(isHi ? "फार्म का नाम" : (isMr ? "शेताचे नाव" : "Farm Entity"), farm?.name ?? "Sahyadri Bio-Farms"),
              _buildDataRow(isHi ? "मुख्य किसान" : (isMr ? "मुख्य शेतकरी" : "Lead Grower"), farm?.owner ?? "Ramesh Patil"),
              _buildDataRow(isHi ? "स्थान व पता" : (isMr ? "स्थान व पत्ता" : "Geographic Origin"), "${farm?.village ?? 'Dindori'}, Maharashtra"),
              _buildDataRow(isHi ? "प्रमाणित खरीदार" : (isMr ? "प्रमाणित खरेदीदार" : "Certified Buyer"), "ITC Agri-Business Division"),
              _buildDataRow(isHi ? "लक्षित फसल" : (isMr ? "मुख्य पीक" : "Target Crop"), "${farm?.activeCrop ?? 'Cotton'} (${farm?.cropStage ?? 'Flowering'})"),
              _buildDataRow(isHi ? "कुल रकबा" : (isMr ? "एकूण क्षेत्र" : "Area"), "${farm?.totalAcres ?? 12.5} Acres"),
            ],
          ),
          const SizedBox(height: 14),
          ...
          _buildCardContainer(
            title: isHi ? "वॉयस लॉग एवं बहु-माध्यम साक्ष्य (Voice Evidence)" : (isMr ? "व्हॉइस नोंदणी व शेती काम तपशील" : "FARMER VOICE LOG & MULTI-MODAL EVIDENCE"),
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      isHi ? "किसान द्वारा बोला गया संदेश:" : (isMr ? "शेतकऱ्याचा आवाज संदेश:" : "Captured Voice Transcript:"),
              ...
              _buildDataRow(isHi ? "कार्य प्रकार" : (isMr ? "कामाचा प्रकार" : "Action Type"), isHi ? "कीटनाशक स्प्रे (SPRAY)" : (isMr ? "फवारणी नोंद (SPRAY)" : "SPRAY")),
              _buildDataRow(isHi ? "उत्पाद" : (isMr ? "वापरलेले औषध" : "Product Mentioned"), "Bio-Neem Power 10,000 PPM"),
              _buildDataRow(isHi ? "मात्रा" : (isMr ? "प्रमाण/डोस" : "Applied Dosage"), "400 ml in 200L Water / Acre"),
              _buildDataRow(isHi ? "लक्षित कीट" : (isMr ? "लक्षित कीड/रोग" : "Target Pest"), isHi ? "सफेद मक्खी व रस चूसक कीट" : (isMr ? "पांढरी माशी व रसशोषक किडी" : "Whitefly & Sucking Pests")),
              _buildDataRow(isHi ? "सत्यापन स्थिति" : (isMr ? "पडताळणी स्थिती" : "Verification"), "VERIFIED 100% (Genuine QR Matched)", valueColor: AppColors.primary),
            ],
          ),
          const SizedBox(height: 14),
            ...
            children: [
              Expanded(
                child: _buildCardContainer(
                  title: isHi ? "फसल स्वास्थ्य" : (isMr ? "पीक आरोग्य" : "CROP HEALTH"),
                  icon: Icons.camera_alt_rounded,
                  color: AppColors.flaggedRed,
                  children: [
                    Text(
                      isHi ? "स्थिति: कीट प्रभावित" : (isMr ? "स्थिती: कीड बाधित" : "Status: Pest Infested"),
                      style: const TextStyle(fontSize: 11.5, fontWeight: FontWeight.bold, color: AppColors.flaggedRed),
                    ),
                    const SizedBox(height: 4),
                    Text(
                      isHi ? "निदान: सफेद मक्खी व पर्ण मुड़ना" : (isMr ? "निदान: पांढरी माशी व चुरडा-मुरडा" : "Diagnosis: Whitefly & Leaf Curl"),
                      style: const TextStyle(fontSize: 11, color: AppColors.textSecondary),
                    ),
                    const SizedBox(height: 4),
                    Text(
                      isHi ? "प्रभावित क्षेत्र: २२.५%" : (isMr ? "बाधित क्षेत्र: २२.५%" : "Affected: 22.5%"),
              ...
              Expanded(
                child: _buildCardContainer(
                  title: isHi ? "लाइव मौसम व स्प्रे" : (isMr ? "हवामान व सल्ला" : "LIVE WEATHER"),
                  icon: Icons.wb_sunny_rounded,
                  color: AppColors.accentAmber,
                  children: [
                    Text(
                      isHi ? "खिड़की: अनुकूल स्प्रे समय" : (isMr ? "सल्ला: फवारणीसाठी योग्य" : "Window: OPTIMAL SPRAY"),
          ...
          _buildCardContainer(
            title: isHi ? "विशेषज्ञ एआई अनुशंसाएं व सुरक्षा कार्य योजना (AI ADVISORY)" : (isMr ? "तज्ज्ञ एआई शिफारशी व सुरक्षा कृती आराखडा" : "EXPERT AI RECOMMENDATIONS & SAFETY ACTION PLAN"),
            icon: Icons.psychology_rounded,
            color: const Color(0xFFD97706),
            children: [
              _buildRecommendationBlock(
                number: "1",
                label: isHi ? "अनुशंसित रासायनिक उपचार (Chemical Prescription)" : (isMr ? "रासायनिक फवारणी व प्रमाण" : "Chemical Prescription"),
                value: isHi
              ...
              _buildRecommendationBlock(
                number: "2",
                label: isHi ? "जैविक एवं प्राकृतिक विकल्प (Organic Alternative)" : (isMr ? "सेंद्रिय व जैविक पर्याय" : "Organic / Biological Alternative"),
                value: isHi
              ...
              _buildRecommendationBlock(
                number: "3",
                label: isHi ? "छिड़काव का सर्वोत्तम समय (Spray Window)" : (isMr ? "फवारणीची योग्य वेळ" : "Optimal Application Window"),
                value: isHi
              ...
              _buildRecommendationBlock(
                number: "4",
                label: isHi ? "तुड़ाई पूर्व प्रतीक्षा अवधि (Pre-Harvest Interval)" : (isMr ? "तोडणीपूर्व प्रतीक्षा कालावधी (PHI)" : "Pre-Harvest Interval (PHI)"),
                value: isHi
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      isHi ? "सुरक्षा व सांस्कृतिक निर्देश:" : (isMr ? "सुरक्षा व प्रतिबंधात्मक उपाय:" : "Safety & Cultural Rules:"),
          ...
          _buildCardContainer(
            title: isHi ? "गुणवत्ता ग्रेड एवं बाजार मूल्य (Compliance & Valuation)" : (isMr ? "गुणवत्ता श्रेणी व शेतमाल मूल्य" : "COMPLIANCE SCORE & ECONOMIC VALUATION"),
            ...
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  _buildStatPill(isHi ? "अनुपालन स्कोर" : (isMr ? "अनुपालन गुण" : "Compliance"), "$_complianceScore%", AppColors.primary),
                  _buildStatPill(isHi ? "ग्रेड" : (isMr ? "श्रेणी" : "Grade"), "Grade A+", const Color(0xFFD97706)),
                  _buildStatPill(isHi ? "सस्टेनेबिलिटी" : (isMr ? "स्थिरता" : "Sustainability"), "96.5/100", AppColors.primaryDark),
                ],
              ),
              const Divider(height: 20),
              _buildDataRow(isHi ? "मंडी आधार दर" : (isMr ? "बाजारभाव" : "Mandi Base Rate"), "₹7,400 / Qtl"),
              _buildDataRow(isHi ? "प्रमाण प्रीमियम" : (isMr ? "प्रमाण प्रीमियम" : "Pramaan Verified Premium"), "+ ₹480 / Qtl", valueColor: AppColors.primary),
              _buildDataRow(isHi ? "कुल प्राप्त दर" : (isMr ? "एकूण दर" : "Total Net Rate"), "₹7,880 / Qtl", valueColor: AppColors.primaryDark),
              _buildDataRow(isHi ? "अनुमानित कुल लॉट मूल्य" : (isMr ? "अंदाजे एकूण मूल्य" : "Total Estimated Lot Value"), "₹1,72,700.00", valueColor: AppColors.primaryDark),
            ],
          ),
          const SizedBox(height: 14),
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      isHi ? "ब्लॉकचेन क्रिप्टोग्राफिक सत्यापन हैश (SHA-256):" : (isMr ? "ब्लॉकचेन क्रिप्टोग्राफिक पडताळणी हॅश:" : "Blockchain Cryptographic Proof (SHA-256):"),
                ...
                Container(
                  ...
                  child: Text(
                    _anchorHash,
                    style: const TextStyle(fontFamily: 'monospace', fontSize: 10, color: AppColors.textPrimary),
                  ),
                ),
              ],
            ),
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: Text(number, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: color)),
        ),
        const SizedBox(width: 8),
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(value, style: const TextStyle(fontSize: 12, color: AppColors.textPrimary, height: 1.3)),
            ],
          ),
        ),
      ],
